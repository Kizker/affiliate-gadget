...
- **2026-09-16 (4-Level Catalog Hierarchy & Bulk Color Variant Update Engine):**
  ...
  - **4. Interactive Bulk Color Modal UI ([`bulk-color-variant-modal.tsx`](file:///src/components/admin/bulk-color-variant-modal.tsx)):** Antarmuka pohon akordeon bertingkat mewah dengan navigasi brand chips, pencarian instan, fitur 1-klik _"Pilih Semua Warna di Kapasitas Ini"_, sticky bar aksi bawah dengan formatter rupiah real-time, dan feedback visual status update.
