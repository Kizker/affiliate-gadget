        ...
        <div className="flex items-center gap-3">
          {onBack ? (
            <button
              type="button"
              onClick={onBack}
              className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-200/80 bg-slate-50 text-slate-700 transition-all hover:text-orange-500 active:scale-95 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300"
              aria-label="Kembali"
            >
