        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between lg:gap-16">
          ...
          <div className="max-w-sm space-y-3.5">
            ...
            <p className="text-xs leading-relaxed text-slate-500 dark:text-slate-400">
              Platform marketplace gadget second / bekas berkualitas terpercaya
              di Indonesia. Menyediakan smartphone second original bergaransi
              toko 30 hari tukar unit dengan paket bonus lengkap 3-in-1.
            </p>
            <div className="flex items-center gap-2 text-slate-500">
              <Building2 className="h-4 w-4 text-blue-600" />
              <span className="text-[11px] font-medium">
                Jaringan Toko Resmi di Indonesia
              </span>
            </div>
          </div>
