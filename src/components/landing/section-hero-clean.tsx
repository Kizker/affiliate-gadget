...
export function SectionHeroClean() {
  ...
  return (
    <section className="relative h-screen overflow-hidden bg-white dark:bg-slate-950 flex items-center pt-16">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12 lg:gap-14">
          ...
          <div className="lg:col-span-6 space-y-4 sm:space-y-6 text-left">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-[3.25rem] font-black tracking-tight text-slate-950 dark:text-white leading-[1.1]">
            ...
            <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400 max-w-lg">
              <span className="hidden sm:inline">Marketplace smartphone &amp; gadget second original berbasis jaringan toko fisik se-Indonesia. Jaminan unit like new, 100% fungsi normal teruji teknisi, garansi toko 30 hari tukar unit, dan paket bonus lengkap 3-in-1.</span>
              <span className="sm:hidden">Gadget second teruji teknisi, garansi toko 30 hari, bonus 3-in-1. Jaringan toko resmi se-Indonesia.</span>
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <Link
                href="/gadget"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-orange-500 px-6 py-3 text-xs sm:text-sm font-bold text-white shadow-sm shadow-orange-500/25 hover:bg-orange-600 active:scale-98 transition-all duration-200"
              >
              ...
              <Link
                href="/toko"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-slate-200/90 bg-white px-5 py-3 text-xs sm:text-sm font-semibold text-slate-800 shadow-2xs hover:bg-slate-50 hover:border-slate-300 active:scale-98 transition-all duration-200 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800"
              >
          ...
          <div 
            className="hidden lg:block lg:col-span-6 select-none"
