  ...
  if (activeSubView !== 'overview') {
    ...
    return (
      <div className="min-h-screen bg-slate-100 pb-28 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
        {/* Sticky Sub-View Header with Back Button */}
        <header className="sticky top-0 z-40 flex items-center justify-between border-b border-slate-200/80 bg-white/95 px-4 py-3 backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/95">
          <button
            type="button"
