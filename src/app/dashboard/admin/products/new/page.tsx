              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="space-y-1.5 flex-1 pr-2">
                  ...
                  <p className="text-[11px] leading-relaxed text-slate-600 dark:text-slate-400">
                    {form.isTaxable
                      ? selectedStore?.isPkp
                        ? `Harga jual produk sudah termasuk PPN ${selectedStore?.vatRate ?? 11}% (Inklusif). DPP dan PPN Keluaran akan otomatis dipisahkan pada pelaporan akuntansi internal ${selectedStore?.companyName || selectedStore?.name || 'Toko'}.`
