...
interface SparepartClientPageProps {
  initialData: {
    products: Product[]
    pagination: {
      page: number
...
export default function SparepartClientPage({
  initialData,
}: SparepartClientPageProps) {
  ...
  // Only fetch on filter changes, not on initial load
  useEffect(() => {
    if (isInitialLoad) {
