          ...
          <div className="shadow-xs rounded-3xl border border-slate-200/80 bg-white p-7 dark:border-slate-800 dark:bg-slate-900 sm:p-9">
            ...
            <div className="mb-6 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2.5">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] opacity-75">Beli Gadget Second</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] opacity-75">Daftar Cabang Toko</p>
                  </div>
                </button>
              </div>
              ...
              {formData.role === 'MITRA' && (
                <div className="flex items-center justify-center gap-1.5 pt-1 text-[11px] text-slate-500 duration-200 animate-in fade-in dark:text-slate-400">
                  ...
                  <span>
                    Verifikasi pendaftaran toko diproses setelah registrasi
                  </span>
                </div>
              )}
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, honeypotField: e.target.value })
                }
