...
import { MobileStoreDirectoryView } from '@/components/store/mobile-store-directory-view'
import {
  Store,
  MapPin,
  Clock,
...
export default function TokoDirectoryPage() {
  ...
  return (
    <>
      {/* 1. Mobile View — Figma Screen 4: Jaringan Toko Resmi */}
      <div className="block md:hidden">
        <MobileStoreDirectoryView
          stores={filtered}
          loading={loading}
      ...
      {/* 2. Desktop View — Rich Grid & Gradient Cards */}
