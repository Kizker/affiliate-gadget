...
async function main() {
  ...
  console.log(
    '👥 1. Memeriksa & Mengisi User Ekosistem (Customer, Teknisi, Mitra)...'
  )
  ...
  for (const c of customers.slice(0, 40)) {
    const addrCount = await prisma.userAddress.count({
      where: { userId: c.id },
    })
    if (addrCount < 2) {
  ...
  if (existingBankAccs === 0) {
    await prisma.bankAccount.createMany({
      data: [
        {
          category: BankAccountCategory.SPAREPART,
          bankName: 'BCA',
        ...
        {
          category: BankAccountCategory.JASA,
          bankName: 'BCA',
          accountNumber: '8830999123',
          accountName: 'PT GADGET JAYA SENTOSA - SERVIS',
        },
        {
          category: BankAccountCategory.JASA,
          bankName: 'BNI',
          accountNumber: '0839210293',
          accountName: 'PT GADGET JAYA SENTOSA - SERVIS',
        },
        {
          category: BankAccountCategory.SEWA,
          bankName: 'BCA',
          accountNumber: '8830555678',
          accountName: 'PT GADGET JAYA SENTOSA - RENTAL',
        },
        {
          category: BankAccountCategory.SEWA,
          bankName: 'BRI',
          accountNumber: '034101000998877',
          accountName: 'PT GADGET JAYA SENTOSA - RENTAL',
        },
      ],
    })
  ...
  console.log(
    '🔧 4. Mengisi Data Teknisi & Layanan Servis (Technician & Service)...'
  )
        ...
        data: [
          {
            ...
            description:
              'Pembersihan menyeluruh cooling fan, penggantian pasta pendingin kelas termal tinggi Arctic MX-4.',
          ...
          },
          {
            ...
            description:
              'Penggantian modul baterai 100% kapasitas asli dengan kalibrasi sensor daya & garansi 90 hari.',
          ...
          },
          {
            ...
            description:
              'Cek voltase short-circuit komponen motherboard dengan thermal camera dan osiloskop presisi.',
          ...
          },
          {
            ...
            description:
              'Solusi gadget tidak bisa dicas, konektor longgar, atau suara telepon tidak terdengar.',
            category: ServiceCategory.SERVIS_LENGKAP,
            price: 250000,
            minPrice: 200000,
            maxPrice: 400000,
  ...
  console.log(
    '🏬 5. Mengisi Data Mitra Bengkel Cabang (Mitra, Schedule, Service, Image)...'
  )
  for (let i = 0; i < mitraUsers.length; i++) {
    ...
    const mitra = await prisma.mitra.upsert({
      ...
      create: {
        ...
        description:
          'Bengkel servis rekanan resmi platform Affiliate Gadget dengan teknisi bersertifikat dan garansi suku cadang original.',
    ...
    const svcCount = await prisma.mitraService.count({
    ...
    if (svcCount === 0) {
      await prisma.mitraService.createMany({
        data: [
          {
            mitraId: mitra.id,
            name: 'Ganti LCD Kilat 2 Jam',
            description: 'Pemasangan layar OLED presisi dengan seal anti-air',
            price: 'Rp 450.000 - Rp 2.500.000',
          },
          {
            mitraId: mitra.id,
            name: 'Bypass iCloud / Bootloop Fix',
            description: 'Flashing firmware resmi & recovery data pengguna',
            price: 'Rp 200.000 - Rp 500.000',
          },
          {
            mitraId: mitra.id,
            name: 'Ganti Housing / Backdoor Pecah',
            description: 'Pergantian kaca belakang dengan laser debonding rapi',
  ...
  console.log(
    '📝 6. Mengisi Formulir Pengajuan Cabang Toko (StoreApplication)...'
  )
    ...
    const rentalList = [
      {
        ...
        desc: 'Kamera full-frame 33MP untuk produksi video promosi & konten live streaming berkualitas studio.',
        price: 350000,
        deposit: 2000000,
        stock: 5,
        images: [
      ...
      },
      {
        ...
        desc: 'Lensa zoom standar kelas G-Master dengan autofokus ultra cepat & ketajaman optik superior.',
        price: 200000,
        deposit: 1500000,
        stock: 6,
        images: [
      ...
      },
      {
        ...
        desc: 'Stabilizer kamera profesional berbahan carbon fiber untuk footage sinematik tanpa guncangan.',
        price: 175000,
        deposit: 1000000,
        stock: 8,
        images: [
      ...
      {
        name: 'Apple iPad Pro 12.9 M2 WiFi (Sewa Event)',
        desc: 'Tablet layar besar Liquid Retina XDR ideal untuk registrasi pengunjung, POS event, atau preview foto.',
        price: 250000,
        deposit: 1500000,
        stock: 10,
        images: [
      ...
      },
      {
        ...
        desc: 'Laptop editing monster bertenaga M3 Max untuk rendering video 4K/8K di lokasi shooting tanpa lag.',
        price: 650000,
        deposit: 4000000,
        stock: 4,
        images: [
      ...
      },
      {
        ...
        desc: 'Kamera aksi tahan air hingga 10 meter dengan stabilisasi HyperSmooth 6.0 & perekaman HDR 5.3K.',
        price: 120000,
        deposit: 800000,
        stock: 12,
        images: [
      ...
      },
      {
        ...
        desc: 'Drone ringan di bawah 249g dengan sensor rintangan omnidirectional dan transmisi video 20km.',
        price: 300000,
        deposit: 2000000,
        stock: 5,
        images: [
      ...
      },
      {
        ...
        desc: 'Sistem mikrofon nirkabel 32-bit float recording untuk audio kristal bening anti-clipping.',
        price: 150000,
        deposit: 1000000,
        stock: 10,
        images: [
      ...
      {
        name: 'Samsung Galaxy S24 Ultra 512GB (Sewa Konser)',
        desc: 'HP terbaik untuk rekam video konser dengan 100x Space Zoom dan mikrofon audio zoom presisi.',
        price: 350000,
        deposit: 2500000,
        stock: 8,
        images: [
      ...
      {
        name: 'Insta360 X3 360-Degree Action Cam',
        desc: 'Perekam video 360 derajat 5.7K dengan efek invisible selfie stick dan reframing cerdas.',
        price: 160000,
        deposit: 1000000,
        stock: 7,
        images: [
      ...
      },
      {
        ...
        desc: 'Lampu studio pencahayaan 200W daylight dengan kontrol via aplikasi Bluetooth Sidus Link.',
        price: 130000,
        deposit: 800000,
        stock: 6,
        images: [
      ...
      {
        name: 'Apple iPhone 15 Pro Max 256GB (Sewa Acara)',
        desc: 'Smartphone flagship untuk live streaming TikTok/Shopee dengan resolusi video ProRes dan koneksi USB-C cepat.',
        price: 320000,
        deposit: 2500000,
        stock: 10,
        images: [
    ...
    for (const r of rentalList) {
      await prisma.rentalItem.create({
        data: {
          ...
          terms: [
            'Wajib e-KTP asli & deposit dana',
            'Dilarang membongkar unit',
    ...
    const articleList = [
      {
        ...
        title:
          '7 Rahasia Merawat Battery Health iPhone Tetap Awet 100% Selama Bertahun-tahun',
        category: 'Tips & Trik',
        excerpt:
          'Jangan biarkan baterai iPhone Anda drop drastis! Ikuti kebiasaan pengisian daya yang tepat sesuai standar industri Apple.',
        tags: ['iPhone', 'Baterai', 'Tips Gadget', 'Apple'],
        coverImage:
          'https://images.unsplash.com/photo-1592899677977-9c10ca588bbd?w=800&q=80',
        content:
          'Baterai lithium-ion bekerja optimal pada siklus suhu ruang antara 16° hingga 22° C. Hindari mengisi daya sambil bermain game berat...',
      },
      {
        slug: 'perbedaan-lcd-original-vs-oem-incell',
        title:
          'Mengenal Perbedaan Layar LCD Original OLED vs OEM Incell: Mana yang Paling Pas Buat Anda?',
        category: 'Panduan Servis',
        excerpt:
          'Ketahui aspek sensitivitas sentuhan, saturasi warna, konsumsi daya baterai, dan durabilitas sebelum mengganti layar HP pecah Anda.',
        tags: ['LCD', 'Servis HP', 'OLED', 'Sparepart'],
        coverImage:
          'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&q=80',
        content:
          'Layar Original OLED menawarkan ketajaman kontras rasio tak hingga dan warna hitam pekat yang sempurna. Sementara OEM Incell adalah opsi hemat...',
      },
      {
        slug: 'keuntungan-beli-gadget-bergaransi-toko-offline',
        title:
          'Mengapa Belanja Gadget di Toko Fisik Multi-PT Jauh Lebih Tenang Dibanding Toko Online Gelap?',
        category: 'Edukasi Konsumen',
        excerpt:
          'Kepastian garansi 30 hari tukar baru, bukti faktur pajak legal, dan dukungan servis tatap muka langsung di mall-mall terdekat.',
        ...
        content:
          'Banyak pembeli online terjebak unit black market tanpa perlindungan IMEI resmi. Dengan jaringan toko fisik Multi-PT kami, seluruh unit terdaftar...',
      },
      {
        slug: 'komparasi-samsung-s24-ultra-vs-iphone-15-pro-max',
        title:
          'Head-to-Head Flagship 2026: Samsung Galaxy S24 Ultra vs Apple iPhone 15 Pro Max',
        category: 'Review Gadget',
        excerpt:
          'Komparasi menyeluruh kamera 200MP, titanium frame, efisiensi Snapdragon 8 Gen 3 vs A17 Pro, serta fitur AI sehari-hari.',
        tags: ['Samsung', 'Apple', 'Flagship', 'Review'],
        coverImage:
          'https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=800&q=80',
        content:
          'Kedua ponsel puncak ini mewakili mahakarya teknologi masa kini. Jika produktivitas stylus S-Pen adalah prioritas Anda...',
      },
      {
        slug: 'cara-klaim-garansi-30-hari-tukar-unit-baru',
        title:
          'Panduan Lengkap Klaim Garansi 30 Hari Ganti Unit Baru Tanpa Ribet',
        category: 'Layanan Garansi',
        excerpt:
          'Langkah mudah verifikasi serial number, upload foto kerusakan fungsi, dan pengiriman kurir ekspres gratis.',
        tags: ['Garansi', 'Customer Service', 'Klaim Retur'],
        coverImage:
          'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&q=80',
        content:
          'Komitmen kami adalah kepuasan 100%. Apabila unit yang Anda beli mengalami cacat fungsi pabrik dalam 30 hari...',
      },
      {
        slug: 'panduan-memilih-storage-hp-128gb-vs-256gb',
        title:
          '128GB vs 256GB vs 512GB: Berapa Kapasitas Memori HP yang Benar-Benar Anda Butuhkan?',
        category: 'Panduan Pembelian',
        excerpt:
          'Simulasi penggunaan file video 4K, instalasi game AAA, dan cache WhatsApp untuk memilih kapasitas storage yang tepat.',
        tags: ['Storage', 'Tips Belanja', 'Smartphone'],
        coverImage:
          'https://images.unsplash.com/photo-1512499617640-c74ae3a79d37?w=800&q=80',
        content:
          'Di era rekaman video beresolusi 4K 60fps, file video berdurasi 1 menit saja bisa menghabiskan 400MB memori...',
      },
    ]
    ...
    for (let i = 0; i < 150; i++) {
      ...
      await prisma.review.create({
        data: {
          ...
          sellerReply:
            'Terima kasih banyak kak atas kepercayaannya! Semoga gadget barunya awet dan berkah selalu 🙏',
  ...
  console.log(
    '🧾 10. Mengisi Faktur Tagihan (Invoice) & Kartu Garansi (Warranty) untuk Seluruh Pesanan...'
  )
  ...
  for (const ord of orders) {
    ...
    if (
      !ord.warranty &&
      ['COMPLETED', 'SHIPPED', 'IN_PROGRESS'].includes(ord.status)
    ) {
      const startDate = ord.completedAt || ord.createdAt
      const endDate = new Date(startDate.getTime() + 30 * 24 * 60 * 60 * 1000)
      await prisma.warranty
        .create({
          data: {
            orderId: ord.id,
            startDate,
    ...
    const notifTemplates = [
      {
        ...
        msg: 'Pesanan baru Anda telah kami terima dan menunggu verifikasi pembayaran.',
      },
      {
        type: NotificationType.PAYMENT_VERIFIED,
        title: 'Pembayaran Dikonfirmasi',
        msg: 'Pembayaran transfer bank Anda telah terverifikasi lunas. Penjual sedang menyiapkan barang.',
      },
      {
        type: NotificationType.ORDER_STATUS_CHANGED,
        title: 'Paket Sedang Dikirim',
        msg: 'Pesanan Anda telah diserahkan ke kurir JNE Express dengan nomor resi aktif.',
      },
      {
        type: NotificationType.NEW_REVIEW,
        title: 'Ulasan Anda Tayang',
        msg: 'Terima kasih atas ulasan bintang 5 Anda pada produk gadget favorit!',
      },
      {
        type: NotificationType.NEW_MESSAGE,
        title: 'Pesan Baru dari Toko',
        msg: 'Penjual membalas inkuiri Anda mengenai status garansi unit.',
      },
    ]
  ...
  console.log(
    '💬 14. Mengisi Percakapan Servis Teknisi (ChatRoom & ChatMessage)...'
  )
          ...
          data: [
            {
              ...
              senderId: cust.id,
              content:
                'Halo mas teknisi, apakah bisa konsultasi ganti baterai iPhone 13?',
              isRead: true,
              createdAt: randomDate(5),
            },
            {
              roomId: room.id,
              senderId: tech.userId,
              content:
                'Bisa kak! Baterai original ready stok, pengerjaan sekitar 45 menit bisa ditunggu di bengkel.',
              isRead: true,
            ...
            },
            {
              roomId: room.id,
              senderId: cust.id,
              content: 'Siap mas, besok sore saya mampir ya. Terima kasih!',
              isRead: true,
  ...
  console.log(
    '🏢 15. Mengisi Ruang Obrolan Toko & Admin (AdminChatRoom & AdminChatMessage)...'
  )
  const existingAdminRooms = await prisma.adminChatRoom.count()
  if (existingAdminRooms < 20) {
    const existingRoomsWithOrder = await prisma.adminChatRoom.findMany({
      where: { orderId: { not: null } },
      select: { orderId: true },
    })
    const usedOrderIds = new Set(existingRoomsWithOrder.map((r) => r.orderId!))
    const availableOrders = orders.filter((o) => !usedOrderIds.has(o.id))

    for (let i = 0; i < 15; i++) {
      const cust = randomElement(customers)
      const st = randomElement(stores)
      const ord = availableOrders.length > 0 ? availableOrders.pop() : null
          ...
          data: [
            {
              roomId: room.id,
              senderId: cust.id,
              content: 'Halo admin, apakah produk ini masih tersedia stoknya?',
              isRead: true,
            ...
            },
            {
              roomId: room.id,
              senderId: cust.id,
              content: 'Saya mau order warna Space Gray varian 256GB.',
              isRead: true,
  ...
  if (existingChatsCount < 10) {
    for (let i = 0; i < 10; i++) {
      ...
      const chatId = `chat_legacy_${Date.now()}_${i + 1}`
      try {
          ...
          data: [
            {
              ...
              chatId,
              senderId: c.id,
              content: 'Pertanyaan seputar metode pembayaran kartu kredit',
              isRead: true,
              updatedAt: new Date(),
            },
            {
              ...
              chatId,
              senderId: c.id,
              content: 'Apakah mendukung cicilan 0% 12 bulan?',
              isRead: true,
              updatedAt: new Date(),
            },
          ],
      ...
      data: [
        {
          ...
          subtitle:
            'Voucher ekstra Rp 500.000 untuk transaksi dengan Gojek Instant.',
          bannerUrl:
        ...
        },
        {
          ...
          subtitle:
            'Teknisi profesional siap melayani di 8 kota besar Indonesia.',
          bannerUrl:
            'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&q=80',
        ...
        },
        {
          ...
          subtitle:
            'Bawa HP lama Anda ke cabang toko Roxy Mas atau WTC Surabaya, langsung terima nilai tertinggi!',
          bannerUrl:
            'https://images.unsplash.com/photo-1556742049-0a67c5574f73?w=800&q=80',
  ...
  if (existingAuditLogs < 200) {
    ...
    for (let i = 0; i < 150; i++) {
      ...
      logs.push({
        userId: u.id,
        action,
        entityType: action.includes('ORDER')
          ? 'Order'
  ...
  console.log(
    '✨ SEMUA TABEL TELAH DIISI DATA MASIF SECARA TUNTAS & BERHASIL 100%!'
  )
}
